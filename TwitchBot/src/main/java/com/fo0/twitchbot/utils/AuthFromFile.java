...
public class AuthFromFile {
	...
	private static final String FILE_PATH_TWITCH_OAUTH_KEY = "auth/twitch_oauth.key";
	...
	private static final String FILE_PATH_GOOGLE_TRANSLATOR_KEY = "auth/google_translator.key";
	...
	public static String getTwitchOauthKey() {
		if (!Paths.get(FILE_PATH_TWITCH_OAUTH_KEY).toFile().exists()) {
			...
			Logger.info("start creating an empty file: " + Paths.get(FILE_PATH_TWITCH_OAUTH_KEY).toAbsolutePath());
			try {
	...
	public static String getGoogleTranslatorKey() {
		if (!Paths.get(FILE_PATH_GOOGLE_TRANSLATOR_KEY).toFile().exists()) {
			...
			Logger.info("start creating an empty file: " + Paths.get(FILE_PATH_GOOGLE_TRANSLATOR_KEY).toAbsolutePath());
			try {
